...
\begin{tabular}{@{}l|lll@{}}
\toprule
\textbf{Pillar/Perspective}& \textit{Development of an IWS} & \textit{Usage of an IWS} & \textit{Nature of an IWS} \\
\midrule
\textit{Software Quality} & X & X & X \\
\textit{Probabilistic \& Non-Deterministic Systems} & X & X & X \\
\textit{APIs \& their usability} & X & X & X\\
\bottomrule
\end{tabular}
\end{table}
