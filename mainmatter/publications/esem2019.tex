...
\begin{enumerate}[label=\textbf{(\arabic*)}]
  \item \textit{defining the \gls{se} \gls{ka}}: The software engineering \gls{ka}, as defined by the \glsac{swebok}, is software construction;
