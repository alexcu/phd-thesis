\chapter[An integration architecture tactic to guard \gls{ai}-first components]
{An integration architecture tactic to guard \gls{ai}-first components\pubfootnote{Cummaudo:2020fse}}
\label{ch:fse2020}
...
\begin{figure*}[th]
    ...
    \begin{subfigure}{.3\linewidth}
        \centering
        \includegraphics[width=.8\linewidth]{evolution-apples}
        \caption{\texttt{`natural foods'} (.956)~~\ra{}~~\texttt{`granny smith'} (.986)}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.3\linewidth}
        \centering
        \includegraphics[width=.8\linewidth]{evolution-snow}
        \caption{\texttt{`skiing'} (.937)~~\ra{}~~\texttt{`snow'} (.982)}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.3\linewidth}
        \centering
...
\begin{figure*}[t]
    ...
    \caption{\textit{Top:} Accessing an intelligent service directly. \textit{Bottom:} Primary components of the Proxy Server approach.}
...
\begin{table*}[t!]
    \centering
    \caption{Potential reasons for a \texttt{412 Precondition Failed} response.}
...
\afterpage{\begin{landscape}\begin{figure*}[t]
    ...
    \caption{State diagram for the four workflows presented.}
