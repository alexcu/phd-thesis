...
{Interpreting Pain-Points in Computer Vision Services\pubfootnote{Cummaudo:2019icse}}
\label{ch:icse2020}
...
% - CHANGES: Such API changes must be substantially documented. To address such issues,~\citet{Cummaudo:2019icsme} suggests that developers mitigate these threats by creating and testing against a representative sample of their data-sets.
% - CONCEPTS Recent work of~\citet{Cummaudo:2019icsme} reported that many such terminologies between vendors are different, and this shows that confusion begins to arise in developers as a result. 
