...
\begin{table} 
\caption[Sample questions comparing automated (C) and human rater (R1, R2, R3) classifications]{Human Raters (\textit{R1, R2, R3}) versus automated classifier (\textit{C)}. Questions located at: https://stackoverflow.com/q/[ID].}
