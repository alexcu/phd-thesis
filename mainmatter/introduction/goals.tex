...
\begin{enumerate}[label=\textbf{RQ\arabic*.}, ref=RQ\arabic*, leftmargin=3.5\parindent, rightmargin=1\parindent]
...
\begin{enumerate}[label=\textbf{RQ\arabic*.}, ref=RQ\arabic*, leftmargin=3.5\parindent, rightmargin=1\parindent,start=2]
...
\begin{enumerate}[label=\textbf{RQ\arabic*.}, ref=RQ\arabic*, leftmargin=3.5\parindent, rightmargin=1\parindent,start=3]
