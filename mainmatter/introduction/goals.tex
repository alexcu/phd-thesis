...
\begin{enumerate}[label=\faQuestionCircle~~\textbf{RQ\arabic*.}, ref=RQ\arabic*, leftmargin=2.75\parindent, rightmargin=1\parindent,start=3]
  ...
  \begin{enumerate}[label=\textit{RQ3.\arabic*.}, ref=RQ3.\arabic*]
    \item What aspects of \glspl{cvs} and its documentation do developers struggle with, as expressed as pain-points within \glslong{so} questions?\label{rq:icse:rq1}% %KQ: [Exploratory question] to understand phenomena: Description and Classification question.
    \item Is the distribution of these pain-points different to established \glslong{cvs} fields?\label{rq:icse:rq2}% KQ: [Relationship Question] between two different phenomenon to assess relations (correlation)
