...
\def\RQTwoTextDocumentationWhatIsCompleteDocs{What \gls{api} documentation artefacts compromise a `complete' \gls{api} document, according to both literature and practitioners?}
...
% RQ3
\def\RQThreeTextDevMiscomprehension{Are \glspl{cvs} more misunderstood than conventional software domains?}
...
\def\RQThreeTextDevMiscomprehensionVsConventional{Is the distribution of \gls{cvs} pain-points different to established software engineering domains, such as mobile or web development?}
