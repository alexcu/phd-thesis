...
\subsubsection{\cref{ch:background}: Background} This chapter provides an overview of prior studies broadly around the development, usage, and nature of \glspl{iws}. We use three perspectives to describe prior work; that of of software quality (particularly, reliability), probabilistic and non-deterministic systems, and explanation and communication theory.
