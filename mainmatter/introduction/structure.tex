...
\begin{table}
  ...
  \tablefit{\begin{tabular}{rp{0.4\linewidth}ccc|cc}
    ...
    % ASE
    \citep{Graetsch:2020ase-industry}&
    35\textsuperscript{th} IEEE/ACM International Conference on Automated Software Engineering &
    ASE&
    A &
    \textit{In Progress}&
    \cref{ch:ase2020-industry}&
    \ref{rq:devs:frustration}\\
