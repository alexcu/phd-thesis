...
\begin{table}
  ...
  \tablefitlandscape{0.85}{\begin{tabular}{rp{0.335\linewidth}ccc|cc}
    ...
    43\textsuperscript{rd} International Conference on Software Engineering (Software Engineering in Practice Track)&
    SEIP&
    A* &
    \textit{In Progress}&
