...
\clearpage
\section{Detailed Suggested Improvements}\label{tse2020:sec:suggested-improvements}
...
% \todo{ is it possible to link these to the type of questions we found on Stackoverflow? AC: Yes -- screenshots may be needed for that though (i.e., to make it tangible.) Worth it?}
