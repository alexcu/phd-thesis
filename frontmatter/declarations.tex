%\def\authorsignature{/Users/Alex/Desktop/AC-Sig.pdf}

\cleardoubleevenemptypage
\pdfbookmark[1]{Candidate Declaration}{candidatedeclaration}
\phantomsection
...
\parbox[b]{0.4\linewidth}{
  \raggedleft
  \ifdefined\authorsignature{\includegraphics[width=0.7\linewidth]{\authorsignature}}\else\fi
...
\cleardoubleevenemptypage
\pdfbookmark[1]{Access to Thesis}{accesstothesis}
\phantomsection
