% TODO: Go through each acronym to ensure it is properly cited
...
\newacronym{dsm}{DSM}{Distributional Semantic Model}
\newacronym{ils}{ILS}{In-Literature Score}
\newacronym{ips}{IPS}{In-Practice Score}
...
\newacronym{solo}{SOLO}{Structure of the Observed Learning Outcome}
