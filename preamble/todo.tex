...
\linespread{1}
\usepackage{etoolbox}
\newcommand*{\missingreference}{\mbox{\colorbox{yellow}{?REF?}}}
\newcommand*{\missingcitation}{\mbox{\colorbox{red}{?CITE?}}}
\makeatletter

\newcommand{\newcontent}[0]{
  \renewcommand\thelinenumber{\color{red}\arabic{linenumber}}
}
\newcommand{\oldcontent}[0]{
  \renewcommand\thelinenumber{\color{black}\arabic{linenumber}}
}
